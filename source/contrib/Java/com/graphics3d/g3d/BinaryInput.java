...
public class BinaryInput {
    ...
    public BinaryInput(String filename) 
	throws FileNotFoundException, IOException {
	this(filename, Constants.littleEndian);
    }

    public BinaryInput(URL url) throws IOException {
	this(url, Constants.littleEndian);
    }
	...
	this(data, offset, length, Constants.littleEndian);
    }
	...
	this(stream, Constants.littleEndian);
    }
	...
	if (byteOrder == Constants.littleEndian) {
