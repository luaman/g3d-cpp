...
\endhtmlonly
  ...
  @section shadows Shadows
   G3D::MeshAlg, G3D::beginShadows, G3D::markShadows, G3D::endShadows

   G3D::RenderDevice::configureShadowMap, depth textures
	
  @section reflections Reflections
   G3D::RenderDevice::configureReflectionMatrix
