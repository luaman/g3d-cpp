/**
  ...
  Notes:
  <UL>
  <LI>The NVIDIA headers include each other in a relative fashion, hence
  you must put both of the NVIDIA include directories in the path.  You
  can use any OpenGL header set you want; the NVIDIA library is convenient
  but not necessary.
...
o
  @created 2002-01-01
  @edited  2003-02-09 ekern/morgan
 */
