...
void doGraphics() {
    ...
    renderDevice->beginFrame();
        ...
        /*
            ...
            Draw::capsule(Capsule(Vector3(-3, 3, 0), Vector3(-3, 5, 0), 1), renderDevice);

            Draw::box(Box(Vector3(-1,-1,-1), Vector3(1,1,1)), renderDevice);

            Draw::sphere(Sphere(Vector3(2,2,2), 1), renderDevice);
